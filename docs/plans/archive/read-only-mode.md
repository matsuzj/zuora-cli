...
> **歴史的文書(2026-07-08 アーカイブ)**: 2026-03 の設計プラン。本文の
> allowlist は 2026-03-26 時点のスナップショットで、出荷後拡張(#411/#435)を
> 含まない。現在の正: 実装は `internal/api/client.go`、文書は
> [docs/read-only.md](../../read-only.md)(生成+lint ドリフトゲート)。
