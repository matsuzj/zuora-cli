...
func NewCmdCreate(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  zr charge create --body @charge.json
...
func runCreate(cmd *cobra.Command, opts *createOptions) error {
	...
	resp, err := client.Post("/commerce/charges", bodyReader)
	if err != nil {
		return err
	}

	return output.RenderJSONWithMessage(f.IOStreams, resp.Body, fmtOpts, "Charge created.\n")
}
