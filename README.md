...
**Destructive operations**: irreversible commands require an explicit `--confirm` flag: `zr account delete`, `zr billrun cancel`, `zr billrun delete`, `zr contact delete`, `zr contact scrub`, `zr data-query cancel`, `zr fulfillment delete`, `zr fulfillment-item delete`, `zr invoice reverse`, `zr invoice writeoff`, `zr omnichannel delete`, `zr order cancel`, `zr order delete`, `zr order delete-async`, `zr order revert`, `zr prepaid deplete`, `zr prepaid reverse-rollover`, `zr subscription cancel`, `zr subscription delete`, `zr usage delete`.
